...
import min.entity.Goods;
import min.entity.Tops;
import min.entity.Types;
import min.service.GoodService;
import min.service.SkuService;
import min.service.TopService;
import min.service.TypeService;
import min.util.PageUtil;
...
public class IndexController {
    ...
    @GetMapping("/stock")
    public @ResponseBody
    int stock(int goodid, int colorid, int sizeid) {
